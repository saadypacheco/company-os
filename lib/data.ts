...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tagline: "IA que convierte caos de WhatsApp en inteligencia comercial",
    description: "Asistente IA para líderes de ventas. Captura mensajes de grupo, transcribe audios, estructura eventos comerciales en memoria buscable + dashboard.",
    status: "active",
    stack: ["Next.js 14", "FastAPI", "Supabase", "Whisper", "LLM", "WAHA"],
    category: "IA / SaaS",
    repoPath: "MentorComercial",
    features: ["Transcripción Whisper", "Memoria estructurada", "Dashboard 'qué pasó hoy'", "Bridge WhatsApp"],
    highlight: "Demo de 2 semanas lista para pilotos",
  },
  {
    id: "apops",
    name: "APOPS",
